...
import com.jennifer.andy.simpleeyes.net.ApiService
import com.sdk.simpleeyes.AndyApplication
...
class RetrofitConfig private constructor() {
    ...
    companion object{
        ...
        private val instance : RetrofitConfig by lazy {
            RetrofitConfig()
        }

        @JvmStatic
        fun getDefaultService() : ApiService = instance.apiService
