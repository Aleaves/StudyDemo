...
import com.sdk.simpleeyes.utils.getElapseTimeForShow
import com.sdk.simpleeyes.widget.EliteImageView
import com.sdk.simpleeyes.widget.ItemHeaderView
import com.sdk.simpleeyes.widget.font.CustomFontTextView
import com.sdk.simpleeyes.widget.font.FontType
import com.sdk.simpleeyes.widget.image.imageloader.FrescoImageLoader
import com.sdk.simpleeyes.widget.viewpager.MarginWithIndicatorViewPager
...
//                }
    ...
    private fun setSingleVideoInfo(helper: BaseViewHolder, item: Content) {
        with(helper) {
            ...
            //点击跳转到视频界面
            itemView.setOnClickListener {
                //VideoDetailActivity.start(mContext, item.data, data as ArrayList<Content>)
            }
    ...
    private fun setSmallCardInfo(helper: BaseViewHolder, data: ContentBean) {
        with(helper) {
            ...
            itemView.setOnClickListener {
                //VideoDetailActivity.start(mContext, data, arrayListOf())
                }
        }
    }
